...
**Quick Start:**
1. **Backend**: Deploy to Railway (set root: `backend/`, configure env vars)
2. **Frontend**: Deploy to Vercel (set root: `frontend/`, configure env vars)
3. **Auto-Deploy**: Both platforms auto-deploy on push to `main` (native Git integration)

**For detailed setup and environment variables, see [CLAUDE.md - Deployment + CI/CD section](./CLAUDE.md#deployment--cicd)**
